...
class LabourWorkPass extends amplify_core.Model {
  ...
  final LabourMedicalInfo? _LabourMedicalInfo;
  final LabourDependentPass? _LabourDependentPass;
  ...
  LabourMedicalInfo? get LabourMedicalInfo {
    return _LabourMedicalInfo;
  }
  
  LabourDependentPass? get LabourDependentPass {
  ...
  factory LabourWorkPass({String? id, required String empID, required String workPermitType, required String arrivalStampingExpiry, required String employmentPassEndorsement, required String immigrationDeptDate, required String employmentPassExpiry, required String employmentPassStatus, List<String>? labourUploadDoc, String? remarks, LabourMedicalInfo? LabourMedicalInfo, LabourDependentPass? LabourDependentPass, String? labourWorkPassLabourMedicalInfoId, String? labourWorkPassLabourDependentPassId}) {
  ...
  LabourWorkPass copyWith({String? empID, String? workPermitType, String? arrivalStampingExpiry, String? employmentPassEndorsement, String? immigrationDeptDate, String? employmentPassExpiry, String? employmentPassStatus, List<String>? labourUploadDoc, String? remarks, LabourMedicalInfo? LabourMedicalInfo, LabourDependentPass? LabourDependentPass, String? labourWorkPassLabourMedicalInfoId, String? labourWorkPassLabourDependentPassId}) {
    return LabourWorkPass._internal(
      id: id,
  ...
  LabourWorkPass copyWithModelFieldValues({
    ...
    ModelFieldValue<LabourMedicalInfo?>? LabourMedicalInfo,
    ModelFieldValue<LabourDependentPass?>? LabourDependentPass,
    ...
    : id = json['id'],
      ...
      _LabourMedicalInfo = json['LabourMedicalInfo'] != null
        ? json['LabourMedicalInfo']['serializedData'] != null
          ? LabourMedicalInfo.fromJson(new Map<String, dynamic>.from(json['LabourMedicalInfo']['serializedData']))
          : LabourMedicalInfo.fromJson(new Map<String, dynamic>.from(json['LabourMedicalInfo']))
        : null,
      _LabourDependentPass = json['LabourDependentPass'] != null
        ? json['LabourDependentPass']['serializedData'] != null
          ? LabourDependentPass.fromJson(new Map<String, dynamic>.from(json['LabourDependentPass']['serializedData']))
          : LabourDependentPass.fromJson(new Map<String, dynamic>.from(json['LabourDependentPass']))
        : null,
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.hasOne(
      ...
      associatedKey: LabourMedicalInfo.ID
    ));
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.hasOne(
      ...
      associatedKey: LabourDependentPass.ID
    ));
