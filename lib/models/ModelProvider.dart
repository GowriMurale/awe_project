...
class ModelProvider implements amplify_core.ModelProviderInterface {
  @override
  String version = "15aa1f2de60fa15ee9c396a758fa3ad3";
  @override
  List<amplify_core.ModelSchema> modelSchemas = [ApplicantDetails.schema, EmployeeNonLocalAcco.schema, EmployeePersonalDoc.schema, EmployeePersonalInfo.schema, EmployeeWorkInfo.schema, InterviewScheduleSchema.schema, LabourDependentPass.schema, LabourMedicalInfo.schema, LabourWorkPass.schema, LeaveStatus.schema, LeaveWorkInfo.schema, LocalMobilization.schema, PersonalDetails.schema, SampleTest1.schema, TerminationWorkInfo.schema, User.schema];
  @override
  ...
  amplify_core.ModelType getModelTypeByModelName(String modelName) {
    switch(modelName) {
      case "ApplicantDetails":
        return ApplicantDetails.classType;
