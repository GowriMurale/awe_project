...
class User extends amplify_core.Model {
  ...
  const User._internal({required this.id, required empID, required userName, required password, required position, required department, selectType, setPermissions, createdAt, updatedAt}): _empID = empID, _userName = userName, _password = password, _position = position, _department = department, _selectType = selectType, _setPermissions = setPermissions, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory User({String? id, required String empID, required String userName, required String password, required String position, required String department, List<String>? selectType, List<String>? setPermissions}) {
  ...
  User copyWith({String? empID, String? userName, String? password, String? position, String? department, List<String>? selectType, List<String>? setPermissions}) {
    return User._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'empID': _empID, 'userName': _userName, 'password': _password, 'position': _position, 'department': _department, 'selectType': _selectType, 'setPermissions': _setPermissions, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
